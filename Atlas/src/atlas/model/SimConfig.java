...
public class SimConfig {
    ...
    public Body getMercury() {
        ...
        double vx = (2.117424563261189E-02 * AU) / EARTH_DAY;
        double vy = (-7.105386404267509E-03 * AU) / EARTH_DAY;
    ...
    public Body getVenus() {
        ...
        double vx = (5.189070188671264E-04 * AU) / EARTH_DAY;
        double vy = (-2.031355258779472E-02 * AU) / EARTH_DAY;
    ...
    public Body getMars() {
        ...
        double vx = (7.533013850513374E-04 * AU) / EARTH_DAY;
        double vy = (1.517888771209419E-02 * AU) / EARTH_DAY;
    ...
    public Body getJupiter() {
        ...
        double vx = (-4.558376589062087E-03 * AU) / EARTH_DAY;
        double vy = (6.439863212743527E-03 * AU) / EARTH_DAY;
    ...
    public Body getSaturn() {
        ...
        double vx = (-4.285166239724135E-03* AU) / EARTH_DAY;
        double vy = (3.884579926013634E-03  * AU) / EARTH_DAY;
    ...
    public Body getUrnus() {
        ...
        double vx = (2.683840344076723E-03* AU) / EARTH_DAY;
        double vy = (2.665016541217006E-03  * AU) / EARTH_DAY;
    ...
    public Body getNeptune() {
        ...
        double vx = (2.584589572083790E-03* AU) / EARTH_DAY;
        double vy = (1.768943546348834E-03  * AU) / EARTH_DAY;
